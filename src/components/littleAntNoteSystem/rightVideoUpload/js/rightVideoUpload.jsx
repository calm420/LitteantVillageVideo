                ...
                <div className="write_article" style={this.state.writeFlag ? {display: 'block'} : {display: "none"}}>
                    <div style={
                        ...
                        <iframe id="iframe_box"
                                src={"http://192.168.50.163:8094/#/addUploadVideo?ident=" + this.state.userId}
                    ...
                    <div style={
                        ...
                        <iframe id="iframe_box_updata"
                                src={"http://192.168.50.163:8094/#/updateVideo?ident=" + this.state.userId + "&vId=" + this.state.vId}
                                frameborder="0"></iframe>
                    </div>
                </div>
