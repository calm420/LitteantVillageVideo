                                    ...
                                    <div>
                                        {
                                            v.littleVideoInfo ?
                                                <div className="item my_flex" onClick={_this.toWaitLookThrough.bind(this, v.littleVideoInfoID, v.type)}>
                                                    <img className='photo' src={v.littleVideoInfo.userInfo ? v.littleVideoInfo.userInfo.avatar : ""} alt="" />
                                                    <div className='right'>
                                                        <span className='author'>{v.littleVideoInfo.userInfo ? v.littleVideoInfo.userInfo.userName:""}</span>
